saisie.controller('activiteGroupeListCTRL',['$scope','$http','$rootScope','$stateParams','$filter',function ($scope,$http,$rootScope,$stateParams,$filter) {
    console.log("entrer dans activiteGroupeListCTRL");
    ...
    function getElements() {
        ...
        for (var l = 0, k = $rootScope.programmeSelect.elements.length; l < k; l++) {
            ...
            if ($rootScope.programmeSelect.elements[l].element.code == "infoSession") {
                nosElements.push($rootScope.programmeSelect.elements[l].element);
            }
            if ($rootScope.programmeSelect.elements[l].element.code == "trancheAge") {
                nosElements.push($rootScope.programmeSelect.elements[l].element);
            }
